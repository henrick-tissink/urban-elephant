...
export const properties: Property[] = [
  {
    ...
    description: [
      ...
      "Its central location in a safe Cape Town neighbourhood further enhances its allure. Secure parking is available for guests. There's truly no other establishment in central Cape Town that offers such a comprehensive experience as 16 On Bree.",
    ],
