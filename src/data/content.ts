...
export const properties: Property[] = [
  {
    ...
    description: [
      ...
      "Perfectly positioned in the heart of Cape Town, Urban Elephant at 16 On Bree places guests within easy reach of the city's best dining, culture and nightlife, all while offering the comfort and security the brand is known for. Secure on-site parking is available for guests, adding convenience to an already seamless 4-star stay. Sophisticated, central and unmistakably Cape Town — this is city living redefined, the Urban Elephant way.",
    ],
